...
int main()
{
	...
	// - Parametro 2: si se le pasa true solamente muestra las pruebas que no están correctas
	//m->Comparar(false, false);
	m->GenerarMensaje("Las salidas de las pruebas propias se generan en la carpeta de SalidasSinProcesar");
	delete m;
	...
	// - Parametro 2: si se le pasa true solamente muestra las pruebas que no están correctas
	//m->Comparar(false, false); 
	m->GenerarMensaje("Las salidas de las pruebas defensa no se estan generando");
	delete m;
