...
namespace FrameworkA1
{
	...
	char *intToStr(int i);
	int cantDatos(NodoListaIntFramework* l);
	int cantDatos(NodoListaIntAux* l);
	...
	*/ 
	...
	int cantDatos(NodoAGIntFramework* a);
...
int FrameworkA1::cantDatos(NodoListaIntAux* l) {
	if (l == NULL)
		return 0;
	return cantDatos(l->sig) + 1;
}

int FrameworkA1::cantDatos(NodoListaIntFramework* l) {
	if (l == NULL)
        return 0;
    return cantDatos(l->sig) + 1;
}

int FrameworkA1::cantDatos(NodoABInt* a) {
	if (a == NULL)
        return 0;
    return cantDatos(a->izq) + cantDatos(a->der) + 1;
}

int FrameworkA1::cantDatos(NodoAGIntFramework* a) {
	if (a == NULL)
        return 0;
...
void FrameworkA1::destruir(NodoListaIntAux *&l) {
    while (l!=NULL) {
