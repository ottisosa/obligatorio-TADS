...
void pruebasMultisetIntNoAcotada(Prueba* pruebaConcreta)
{
    ...
    unsigned int cantU = cantidadElementos(unionS);
    lord = NULL;
    ...
    cout << "Largo de la union: " << cantU << endl;
    ...
    unsigned int cantI = cantidadElementos(interS);
    lord = NULL;
    ...
    cout << "Largo de la interseccion: " << cantI << endl;
    ...
    unsigned int cantD = cantidadElementos(difS);
    lord = NULL;
    while (!esVacio(difS)) {
        int e = elemento(difS);
        FrameworkA1::agregarOrd(lord, e);
    ...
    cout << "Largo de la diferencia: " << cantD << endl;
